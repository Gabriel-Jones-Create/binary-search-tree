...
public class BinaryTreeUtilityTest {
	...
	private BinaryTreeNode<Integer> root, root2, root3, root4, root5, root6, root7;
...
// This tree has over 1 million nodes
	...
	public void setUp() throws Exception {
		...
		assertNotNull("It looks like your configuration file isn't set for BinaryTreeNode.", root5);
		assertNotNull("It looks like your configuration file isn't set for BinaryTreeNode.", root6);
		assertNotNull("It looks like your configuration file isn't set for BinaryTreeNode.", root7);
...
//                        /
//                       4
		return node(node(node(null, 6, null), 3, node(null, 7, null)), 5,
...
//                        /
//                       4
		return node(node(node(null, 1, null), 3, node(null, 2, null)), 5,
				node(node(node(null, 4, null), 1, null), 19, null));
	}
...
//           1   4         7    25
//                        
		return node(node(node(null, 1, null), 3, node(null, 4, null)), 5,
				node(node(null, 7, null), 19, node(null, 25, null)));
	}
...
//                         /    
//                        3      
		return node(node(node(null, 1, null), 2, node(null, 9, null)), 16,
				node(node(node(null, 3, null), 4, null), 20, node(null, 30, null)));
	}

//creating new tree 2
	private BinaryTreeNode<Integer> initRoot7() {
//                    7
//              /            \
//             5             21
//            / \           /
...
//                        /
//                       4
		return node(node(node(null, 8, null), 5, node(null, 6, null)), 7,
				node(node(node(null, 4, null), 2, null), 21, null));
	}
	...
	private void assertIteratorContains(Iterator<Integer> itr, Integer... elems) {
		...
		for (Integer e : elems) {
			...
			found.add(test);
			if (!test.equals(e))
				fail("Expected iterator to produce " + Arrays.toString(elems) + " but start of iterator produced "
						+ found);
		}
...
//logic test for preOrderIterator
	@Test(timeout = 100)
	public void testGetPreOrderIterator2() {
//   test 1
//                    16
//              /            \
//             2              20
...
//                         /    
//                        3    
		Iterator<Integer> preorder6 = utility.getPreOrderIterator(root6);
		assertIteratorContains(preorder6, 16, 2, 1, 9, 20, 4, 3, 30);
//   test 2
//                    7
//              /            \
//             5             21
...
//                        /
//                       4  
		Iterator<Integer> preorder7 = utility.getPreOrderIterator(root7);
		assertIteratorContains(preorder7, 7, 5, 8, 6, 21, 2, 4);
	}
...
// Level order test case
	...
	public void testLevelOrderIterator() {
		Iterator<Integer> itr = utility.getLevelOrderIterator(root);
		assertIteratorContains(itr, 5);

		Iterator<Integer> itr2 = utility.getLevelOrderIterator(root3);
		assertIteratorContains(itr2, 5, 3, 19, 6, 7, 1, 4);
	}
...
//logic test for inOrderIterator
	@Test(timeout = 100)
	public void testGetInOrderIterator2() {
//   test 1
//                    16
//              /            \
//             2              20
...
//                         /    
//                        3    
		Iterator<Integer> itr6 = utility.getPostOrderIterator(root6);
		assertIteratorContains(itr6, 1, 9, 2, 3, 4, 30, 20, 16);
//   test 2
//                    7
//              /            \
//             5             21
...
//                        /
//                       4  
		Iterator<Integer> itr7 = utility.getPostOrderIterator(root7);
		assertIteratorContains(itr7, 8, 6, 5, 4, 2, 21, 7);
	}
...
//   logic test for postOrderIterator
	@Test(timeout = 100)
	public void testGetPostOrderIterator2() {
//   test 1
//                    16
//              /            \
//             2              20
...
//                         /    
//                        3  
		assertEquals(3, utility.getDepth(root6));
//test 2
//                    7
//              /            \
//             5             21
...
//                        /
//                       4
		assertEquals(3, utility.getDepth(root7));
	}
...
//                        3  
		...
		assertTrue(utility.isBalanced(root6, 1));
		assertTrue(utility.isBalanced(root6, 2));
//test 2
//                    7
//              /            \
//             5             21
...
//                        /
//                       4
		assertFalse(utility.isBalanced(root7, 0));
		assertFalse(utility.isBalanced(root7, 1));
		assertTrue(utility.isBalanced(root7, 2));
	}
...
//                        /
//                       4
		assertFalse(utility.isBST(root7));
	}
